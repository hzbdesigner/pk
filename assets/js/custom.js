...
jQuery(document).ready(function() {  
  ...
  var carouselSwiperN = $('.swiper-carousel-n').swiper({
    mode:'horizontal',
    loop: true,
  ...
  $('.swiper-btn-prev').on('click', function(e){
    e.preventDefault()
    carouselSwiperN.swipePrev()
  })

  $('.swiper-btn-next').on('click', function(e){
    e.preventDefault()
    carouselSwiperN.swipeNext()
  })
...
// 		var SMcontroller;
//     SMcontroller = new ScrollMagic();
//     var scene1 = new ScrollScene({triggerElement: ".bar-sort-bar", offset: 200})
//             .setPin('.bar-sort-bar-2')
//             .addTo(SMcontroller)
//             .on("update", function (e) {
//               if( e.target.parent().info("scrollDirection") == "FORWARD"){
//                 $(".bar-sort-bar").hide();
//                 $(".bar-bottom-index").hide();
//                 $(".bar-top-nav-main-2").hide();
//               }
//               if( e.target.parent().info("scrollDirection") == "REVERSE"){
//                  $(".bar-sort-bar").show();
//                  $(".bar-bottom-index").show();
//                  $(".bar-top-nav-main-2").show();
//               }
//             });
//     var scene2 = new ScrollScene({triggerElement: "", offset: 130})
//             .setPin(".bar-book-article-toc")
//             .setClassToggle(".bar-top-nav-main-3","active")
//             .addTo(SMcontroller);
